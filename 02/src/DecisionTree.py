...
classifier = tree.DecisionTreeClassifier(max_depth= 20, min_samples_split = 45, class_weight = {0:0.6585 , 1:1.1591})
...
pd.DataFrame(predictions).to_csv('predictions_DT.txt',index=False,header=False)
