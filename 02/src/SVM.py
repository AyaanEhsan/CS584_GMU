...
classifier =svm.LinearSVC(random_state=20,max_iter=1000)

#Fit the SVM classifier from the training dataset.
...
pd.DataFrame(predictions).to_csv('predictions_SVM.txt',index=False,header=False)
